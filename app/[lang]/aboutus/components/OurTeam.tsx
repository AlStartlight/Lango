        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <AnimatedSection direction="left">
            <div className="space-y-4 md:space-y-6">
              <div>
                <span className="text-2xl md:text-4xl font-bold block">{t('about.team.title')}</span>
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  <span className="text-2xl md:text-4xl font-bold">{t('about.team.subtitle')}</span>
              ...
              <Button href="/reviews" text={t('about.team.cta')} color="black" size="md" />
            </div>
          </AnimatedSection>
