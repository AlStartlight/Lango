    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://*.googletagmanager.com https://*.clerk.accounts.dev https://challenges.cloudflare.com",
